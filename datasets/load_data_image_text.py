...
def get_loader(path, batch_size):
    Standard_img = preprocessing.StandardScaler()
    Standard_text = preprocessing.StandardScaler()
    ...
    img_train = Standard_img.fit_transform(img_train)
    img_test = Standard_img.transform(img_test)

    text_train = Standard_text.fit_transform(text_train)
    text_test = Standard_text.transform(text_test)
